...
<i-card full :title="item2.name" :extra="item2.value" :headerStyle="headerStyle" :thumb="item2.pic" :fontStyle="fontStyle" i-class="card-demo" >
    ...
    <view slot="content" class="des">有效期至:{{item2.desDate}}</view>
    <view slot="content" class="des">数量:{{item2.desNum}}</view>
        <view slot="content" class="des">总价:{{item2.desPrice}}</view>
      <view  slot="content">  <i-button bind:click="handleClick" inline type="success" style="float:right; border: 1px solid green; ">行内按钮</i-button> </view>
</i-card>
</li>
</div>
...
<i-card full :title="item3.name" :extra="item3.value" :headerStyle="headerStyle" :thumb="item3.pic" :fontStyle="fontStyle" i-class="card-demo" >
    ...
    <view slot="content" class="des">有效期至:{{item3.desDate}}</view>
